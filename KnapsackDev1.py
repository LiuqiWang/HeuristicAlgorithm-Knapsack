...
##def load_knapsack(things,knapsack_cap):
    """ Write your heuristic knapsack algorithm in this function using the argument values that are passed
...
from knapsackV5 import load_knapsack # call function I ADDED IT>>>>>>>>>>>
